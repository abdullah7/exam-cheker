...
public class Klausur {
  ...
  private static final String MESSAGE_FORMAT =
          "{0}, {1} hat {2} von 40 möglichen Punkten und eine {3} geschrieben.";
  ...
  public String toString() {
    return MessageFormat.format(MESSAGE_FORMAT, nachname, vorname, gesamtpunktzahl, note);
  }

  private static String[] vornamen = new String[] {
          "Ean", "Markus", "Patrik", "Jonte", "Milan", "Bent", "Rouven", "Aljoscha", "Johnny",
          "Said", "Salim", "Lorenz", "Gerald", "Samuel", "Mailo", "Dirk", "Levi", "Liam", "Elias",
          "Frank", "Burglind", "Isabella", "Leila", "Lani", "Samara", "Vera", "Nelli", "Fee",
          "Gloria", "Renesmee", "Rachel", "Ida", "Lina", "Mathilda", "Laura", "Emma", "Emilia",
          "Fatme", "Bele", "Ella"};

  private static String[] nachnamen = new String[] {
          "Mueller", "Maier", "Schmidt", "Schulz", "Kranz", "Schroeder", "Behrens", "Jansen",
          "Hunter", "Ahler"};
